...
namespace OnibusExpress.Tests.Application.Validators
{
    ...
    public class CreatePassageiroRequestValidatorTests
    {
        private readonly CreatePassageiroRequestValidator _validator = new();
        ...
        [Fact]
        public void Validate_DeveRetornarErro_QuandoCpfForVazio()
        {
            // Arrange
            var request = CriarRequestValido() with
            {
        ...
        [Fact]
        public void Validate_DeveRetornarErro_QuandoCpfForInvalido()
        {
            // Arrange
            var request = CriarRequestValido() with
            {
        ...
        private static CreatePassageiroRequest CriarRequestValido()
        {
